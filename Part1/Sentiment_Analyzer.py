...
class SentimentIntensityAnalyzer(object):
    ...
    def __init__(self, lexicon_file="vader_lexicon.txt"):
        lexicon_full_filepath = "vader_lexicon.txt"
...
if __name__ == '__main__':
	...
	#Enter the file name to get the analysis 
    paragraph = open('test_cases/.txt').read()
    ...
    val = round(paragraphSentiments/len(sentence_list), 4)
    if val < 0:
		print "Negative"
    elif val  < 0.2 :
		print "Neutral"
